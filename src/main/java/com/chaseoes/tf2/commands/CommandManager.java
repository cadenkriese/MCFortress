...
import com.chaseoes.tf2.commands.CommandHelper;
...
public class CommandManager implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender cs, Command cmnd, String string, String[] strings) {
        ...
        if (strings.length == 0) {
            ...
            cs.sendMessage(ChatColor.DARK_AQUA + "Team Fortress 2 " + ChatColor.RESET + "" + ChatColor.DARK_AQUA + "plugin by chaseoes and GamerKing195.");
            return true;
        }
